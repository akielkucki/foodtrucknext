                    ...
                    <div className="flex flex-col items-center justify-between gap-6 lg:flex-row">
                        ...
                        <form className="flex w-full max-w-md gap-3">
                            <input
                                ...
                                className={cn(
                                    "flex-1 rounded-lg border px-4 py-2.5 focus:border-[var(--color-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/20",
                                    isDark
                            ...
                            <button
                                type="submit"
                                className="rounded-lg bg-[var(--color-primary)] px-6 py-2.5 font-semibold text-white transition-colors hover:bg-[var(--color-primary-dark)]"
                            >
                                Subscribe
                            </button>
                        </form>
            ...
            <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-6">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        >
                            Custom food truck builders since 1999. From concept to the street,
                            we bring your mobile kitchen vision to life.
                        </p>
                        <div
                            className={cn(
            ...
            >
                <div className="mx-auto max-w-7xl px-6 py-6 lg:px-8">
                    <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
                        ...
                        >
                            <span>
                                &copy; {new Date().getFullYear()} {brandNameLegal}. All rights
                                reserved.
                            </span>
                            <Link
                                href="/privacy"
